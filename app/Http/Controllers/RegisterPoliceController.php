...
class RegisterPoliceController extends Controller
{
    ...
    public function store(Request $request)
    {
        $input = [
            ...
            'policeJurisdiction'      => $request->input('policejurisdiction'),
            'policeOfficerName'       => $request->input('policeOfficerName'),
            'policePosition'          => $request->input('policePosition'),
            'policeContact'           => $request->input('policeContact'),
            ...
            'policeZipCode'            => $request->input('zipcode'),
        ...
        elseif ($request->input('password') == $request->input('conpassword')) {
            ...
            $isName = $database->collection('police_accounts');
            ...
            {
                //if($name['policeOfficerName'] == $request->input('policeOfficerName'))
                //{
                //    $found = 1;
                //}
            }
            ...
            if($found == 0)
            {
                ...
                $userProperties = [
                    ...
                    'emailVerified' => false,
                    'phoneNumber' => sprintf('+63%s', $request->input('policeContact')),
                    'password' => $request->input('password'),
                    'displayName' => $request->input('policeOfficerName'),
                    'disabled' => false,
                ];
