...
<body style="overflow-y: hidden;">
        ...
        <script type="module">
        var barangay='<?php echo session('barangay');?>';
...
// Initialize Firebase
        ...
        async function GetAllDataRealtime(){
            ...
            const q = query(collection(db,'sos-distress-message'),where("receiving_Brgy","==",barangay),where("status","==","Unread") ); /*where("transfered_to","==",userid.value), where("status","==","Transferred"));*/
...
function showNotification() {
  ...
  //      return;
  //  }
   let title = "A distress message has been received!";
  // let icon = 'https://homepages.cae.wisc.edu/~ece533/images/zelda.png'; //this is a large image may take more time to show notifiction, replace with small size icon
   let body = "Please check it immediately!";
