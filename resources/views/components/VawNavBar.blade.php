        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" style="color: gray;font-size: large;font-weight: 500;" >barangay vaw user name&nbsp;<i class="far fa-user-circle" style="font-size: 25px;" ></i></a>
