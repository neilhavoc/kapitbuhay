...
<html>
    ...
    <head>
        ...
        <title>KapitBuhay - Register Purok Leader</title>
    ...
    <body>
        ...
        <form action="register_PurokLeader" method="POST" enctype="multipart/form-data">
            @csrf
            @if ($notEqual == 'true')
                <div class="container border-secondary">
                    <div class="row mb-3">
                        <div class="col-auto">
                            <label for="brgyname" class="col-form-label">Purok Name:</label>
                        </div>
                        <div class="col-auto ">
                    ...
                    <div class="row g-3 align-items-center mb-2">
                        <div class="col-auto">
                            <label for="cn1" class="col-form-label">Purok Contact Num:</label>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row g-3 align-items-center mb-5">
                        <div class="col-auto">
                            <label for="cn1" class="col-form-label">Purok Leader Full Name:</label>
                        </div>
                        <div class="col-auto">
