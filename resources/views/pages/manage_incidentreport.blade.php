                                ...
                                <table class="table table-hover table-bordered text-center">
                                    <thead class="bill-header cs">
                                        <tr>
                                            ...
                                            <th id="trs-hd-2" class="col-lg-3">Police Station</th>
                                            <th id="trs-hd-3" class="col-lg-3">Date/Time</th>
                                            <th id="trs-hd-4" class="col-lg-3">Victim</th>
                                        ...
                                        <div class="modal-body">
                                            <div class="container border-secondary" style="height:400px; margin-top:0%; margin-bottom:0%;">
                                                <div class="row mt-5 no-gutter">
                                                    <div class="col-md-2 mb-2 fw-bold">Rec ID:</div>
                                                ...
                                                <div class="row mt-3 no-gutter">
                                                    <div class="col-md-2 fw-bold">Date/time: </div>
                                                    <div class="col-md-4"> <input  id="pol_date" type="text" class="form-control align-content-center w-100"  placeholder="" disabled="disabled" ></div>
                                                </div>
                                                <div class="row mt-3 no-gutter">
                                                    <div class="col-md-2 fw-bold">Victim: </div>
                                                    <div class="col-md-4"> <input  id="pol_victim" type="text" class="form-control align-content-center w-100"  placeholder="" disabled="disabled" ></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group mt-3">
                                <table class="table table-hover table-bordered text-center">
                                    <thead class="bill-header cs">
                                        <tr>
                                            <th id="trs-hd-1" class="col-lg-1">Rec ID</th>
                                            <th id="trs-hd-2" class="col-lg-3">Barangay Name</th>
                                            <th id="trs-hd-3" class="col-lg-3">Date/Time</th>
                                            <th id="trs-hd-4" class="col-lg-3">Victim</th>
                                            <th id="trs-hd-4" class="col-lg-2"></th>
                                        </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container border-secondary" style="height:400px; margin-top:0%; margin-bottom:0%;">
                                                ...
                                                <div class="row mt-3 no-gutter">
                                                    <div class="col-md-2 fw-bold">Barangay Name:</div>
