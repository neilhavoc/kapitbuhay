...
<form action="police_reviewdistressmessage/reportAcc/{{ $message['sender_userID']}}" method="POST">
    @csrf
    @method('PUT')
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCnwBnZtVNK_pmkcdWB6BQeH9S9LQUlXew&callback=initMap&v=weekly" defer></script>
@stop
